...
namespace server.Services
{
    public class OfferService : Service<Offer>, IOfferService
    {
        ...
        public async Task<IEnumerable<UserDTO>> GetStudentsByRecruiterAsync(string recruiterId)
        {
            ...
            // Map the results to UserDTO, passing the Student entity to the constructor
            var studentDTOs = studentsWithDetails.Select(s => new UserDTO
            {
                Id = s.Student.Id,
                Email = s.Student.Email,
                UserType = s.Student.UserType,
                FirstName = s.Student.FirstName,
                LastName = s.Student.LastName,
                Instrument = s.Student.Instrument,
                HighSchool = s.Student.HighSchool,
                GraduationYear = s.Student.GraduationYear,
                BandId = s.Student.BandId,
